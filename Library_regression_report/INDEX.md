...
|---|---|
| **MINOR REGRESSION** | 2 |
| **IMPROVEMENT ONLY** | 154 |
| **NO REGRESSION** | 6 |
| **total** | **162** |

## Repo-wide render signals (counted directly from the 324 render files)

| Signal | `old` | `new` |
|---|---|---|
| Total rendered lines | 298,783 | 326,091 |
| `// Unknown type:` lines | 2,370 | 0 |
| Libraries containing any `// Unknown type:` | 101 | 0 |
