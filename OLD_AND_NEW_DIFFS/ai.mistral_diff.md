# ai.mistral — `old` vs `new` render diff

| | |
|---|---|
| **Library folder** | `ai.mistral` |
| **Old file** | `ai.mistral/old/ballerinax_ai.mistral.bal.txt` |
| **New file** | `ai.mistral/new/ballerinax_ai.mistral.bal.txt` |
| **Old lines** | 211 |
| **New lines** | 232 |
| **Lines added** | 23 |
| **Lines removed** | 2 |
...
|---|---|---|---|---|---|
| 1 | 127–164 | 127–180 | Types | +16 | −0 |
| 2 | 197–204 | 213–221 | Client | +2 | −1 |
| 3 | 207–211 | 224–232 | Client | +5 | −1 |
...
`````diff
--- ai.mistral/old/ballerinax_ai.mistral.bal.txt	2026-08-12 12:57:29
+++ ai.mistral/new/ballerinax_ai.mistral.bal.txt	2026-08-12 13:19:19
@@ -127,38 +127,54 @@
...
+@display {label: "Mistral Model Provider"}
